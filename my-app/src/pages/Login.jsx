...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 flex items-center justify-center font-sans relative overflow-hidden">
      ...
      <div className="bg-zinc-900/50 backdrop-blur-xl border border-zinc-800 p-8 rounded-2xl w-full max-w-md shadow-2xl z-10">
        ...
        <form onSubmit={handleEmailAuth} className="space-y-6">
          ...
          <button 
            type="submit" 
            disabled={loading}
            className="w-full bg-indigo-600 hover:bg-indigo-500 text-white font-medium py-3 rounded-lg transition-all active:scale-[0.98] shadow-lg shadow-indigo-600/20 disabled:opacity-50 disabled:cursor-not-allowed"
          >
        ...
        <div className="mt-6">
          <button 
            ...
            className="w-full bg-zinc-900 border border-zinc-700 hover:bg-zinc-800 text-white font-medium py-3 rounded-lg transition-all active:scale-[0.98] flex items-center justify-center gap-3"
          >
